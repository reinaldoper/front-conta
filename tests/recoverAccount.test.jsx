...
import RecoverAccount from '../src/page/RecoverAccount';
...
describe('Transactions recover', () => {
  ...
  test('should return one message "This is an error alert" ', async () => {
    ...
    const title = getByRole('heading', {
      name: /Account recover/i
    });
    expect(title).toBeInTheDocument();
    const button = getByTestId('button-recover');
  ...
  test('should return message "Success" ', async () => {
    ...
    const { debug, getByRole, getByTestId, getByPlaceholderText } = render(
      <BrowserRouter>
        <RecoverAccount />
      </BrowserRouter>
    )
